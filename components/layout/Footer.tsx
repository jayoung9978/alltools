		...
		<footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-auto">
			<div className="container mx-auto px-4 py-8">
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
					...
					<div>
						...
						<ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
							...
							<li>
								<Link href="/calc/vat" className="hover:text-primary-500">
									부가세 계산기
								</Link>
							</li>
							<li>
								<Link href="/calc/pyeong" className="hover:text-primary-500">
									평수 계산기
								</Link>
							</li>
							<li>
								<Link href="/calc/discount" className="hover:text-primary-500">
									할인율 계산기
								</Link>
							</li>
							<li>
				...
				<div className="border-t border-gray-200 dark:border-gray-700 pt-6 text-center text-sm text-gray-600 dark:text-gray-400">
					...
					<p className="mt-2">무료 웹 도구 모음 - 계산기, 변환기, 생성기</p>
				</div>
			</div>
		</footer>
	);
